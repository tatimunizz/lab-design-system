  ...
  return (
    <div className='w-screen h-screen bg-gray-900 flex items-center justify-center flex-col text-gray-100'>
      <header className='flex flex-col items-center'>
        ...
        <Text size='lg' className='text-gray-400 mt-1'>Login and start using it!</Text>
      </header>
      <form className='flex flex-col items-stretch w-full max-w-sm mt-10 gap-4'>
        ...
        <footer className='flex flex-col items-center gap-4 mt-8'>
          <Text asChild size='sm'>
            <a href='#' className='text-gray-400 underline hover:text-gray-200'>Forgort password?</a>
          </Text>
          <Text asChild size='sm'>
            <a href='#' className='text-gray-400 underline hover:text-gray-200'>Don't have an account? Sign in now!</a>
          </Text>
        </footer>
      </form>
    </div>
